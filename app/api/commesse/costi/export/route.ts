...
import { assertActiveUser, getCostActualRows, parseCostFilters } from "@/lib/cost-actual-queries";
...
export async function GET(request: NextRequest) {
  ...
  const fileName = filters.jobOrderId
    ? `costi-commessa-${safeFileSegment(filters.jobOrderId)}.xlsx`
    : "costi-commesse.xlsx";
