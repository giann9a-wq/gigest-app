...
export default async function AdminImportMassivoPage() {
      ...
      <section className="card">
        <div className="mobile-section-header">
          <div>
            ...
            <h1 className="mobile-section-title">Import massivo diario</h1>
          ...
          <div className="admin-request-actions">
              <Link href={"/admin/accessi" as Route} className="mobile-button-secondary">
                Torna ad accessi
              </Link>
            {hasElevatedAccess ? (
          ...
          <div className="admin-grid">
            <div className="card admin-password-form">
              ...
              <p className="muted" style={{ margin: 0 }}>
                L&apos;import massivo e disponibile solo dopo sblocco dell&apos;area admin con la password aggiuntiva.
              </p>
